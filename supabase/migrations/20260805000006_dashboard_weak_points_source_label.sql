-- Item 10.3 du plan de correction du dashboard (analyse détaillée) :
--
-- weak_points ne remontait que category/sub_category/frequency/last_seen_at,
-- sans source_label (ajouté à user_errors en 20260805000005 et renseigné
-- depuis 20260805000006... voir migration précédente pour trackUserError).
-- Nécessaire pour que ActionPlanCard.tsx affiche un rappel du type "Dans ton
-- Examen blanc du 3 août, tu as fait une erreur de type Grammaire
-- (Comparatifs)" sur la card "En attente d'une action ciblée".
