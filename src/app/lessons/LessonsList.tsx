...
const CATEGORY_COLORS: Record<string, { border: string, bg: string, text: string, hoverText: string, hoverIconBg: string, button: string, shadow: string, hoverShadow: string }> = {
  conjugaison: { border: "border-blue-500", bg: "bg-blue-50", text: "text-blue-600", hoverText: "group-hover:text-blue-600", hoverIconBg: "group-hover:bg-blue-600", button: "bg-blue-600 hover:bg-blue-700", shadow: "shadow-blue-100", hoverShadow: "hover:shadow-blue-200" },
  syntaxe: { border: "border-violet-500", bg: "bg-violet-50", text: "text-violet-600", hoverText: "group-hover:text-violet-600", hoverIconBg: "group-hover:bg-violet-600", button: "bg-violet-600 hover:bg-violet-700", shadow: "shadow-violet-100", hoverShadow: "hover:shadow-violet-200" },
  vocabulaire: { border: "border-amber-500", bg: "bg-amber-50", text: "text-amber-600", hoverText: "group-hover:text-amber-600", hoverIconBg: "group-hover:bg-amber-600", button: "bg-amber-600 hover:bg-amber-700", shadow: "shadow-amber-100", hoverShadow: "hover:shadow-amber-200" },
  grammaire: { border: "border-emerald-500", bg: "bg-emerald-50", text: "text-emerald-600", hoverText: "group-hover:text-emerald-600", hoverIconBg: "group-hover:bg-emerald-600", button: "bg-emerald-600 hover:bg-emerald-700", shadow: "shadow-emerald-100", hoverShadow: "hover:shadow-emerald-200" },
  orthographe: { border: "border-rose-500", bg: "bg-rose-50", text: "text-rose-600", hoverText: "group-hover:text-rose-600", hoverIconBg: "group-hover:bg-rose-600", button: "bg-rose-600 hover:bg-rose-700", shadow: "shadow-rose-100", hoverShadow: "hover:shadow-rose-200" },
  default: { border: "border-zinc-500", bg: "bg-zinc-50", text: "text-zinc-600", hoverText: "group-hover:text-zinc-600", hoverIconBg: "group-hover:bg-zinc-600", button: "bg-zinc-600 hover:bg-zinc-700", shadow: "shadow-zinc-100", hoverShadow: "hover:shadow-zinc-200" },
};
  ...
  const renderLessonCard = (lesson: Lesson) => {
    ...
    return (
      <Link href={`/lessons/${lesson.id}`} key={lesson.id} className="h-full">
        <Card className={`relative border-none shadow-xl shadow-zinc-100/70 hover:-translate-y-1 ${colors.hoverShadow} transition-all group cursor-pointer h-full rounded-[2rem] overflow-hidden flex flex-col bg-white border-t-4 ${colors.border}`}>
