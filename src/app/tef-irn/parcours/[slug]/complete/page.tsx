...
export default function ParcoursCompletePage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <div className="min-h-screen bg-zinc-50/50 flex flex-col items-center justify-center p-6 py-12 lg:p-12 overflow-hidden">
      <div className="max-w-3xl w-full text-center space-y-12 relative">
        ...
        >
          <div className="w-40 h-40 bg-white rounded-3xl shadow-sm flex items-center justify-center relative z-10 border border-zinc-100">
            <Trophy size={80} className="text-amber-400 drop-shadow-lg" />
          </div>
          <motion.div
        ...
        <div className="space-y-4">
          <motion.h1
            ...
            className="text-4xl md:text-5xl font-black uppercase text-zinc-900 tracking-tighter"
          >
            Parcours <span className="text-indigo-600">terminé !</span>
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.1 }}
            className="text-base md:text-lg font-medium leading-relaxed text-zinc-500 max-w-xl mx-auto"
          >
            Félicitations ! Vous avez complété avec succès le parcours de
            <span className="text-zinc-900 font-black"> {parcours.category} {parcours.level}</span>.
          </motion.p>
        </div>
        ...
        >
          <Card className="p-6 rounded-3xl border border-zinc-100 shadow-sm bg-white">
            <div className="w-10 h-10 bg-indigo-50 text-indigo-600 rounded-2xl flex items-center justify-center mx-auto mb-4">
              <Target size={20} />
            </div>
            <div className="text-2xl font-black text-zinc-900">100%</div>
            <div className="text-xs font-black text-zinc-500 uppercase tracking-widest">Réussite</div>
          </Card>

          <Card className="p-6 rounded-3xl border border-zinc-100 shadow-sm bg-white">
            <div className="w-10 h-10 bg-emerald-50 text-emerald-600 rounded-2xl flex items-center justify-center mx-auto mb-4">
              <TrendingUp size={20} />
            </div>
            <div className="text-2xl font-black text-zinc-900">+500</div>
            <div className="text-xs font-black text-zinc-500 uppercase tracking-widest">XP Bonus</div>
          </Card>
          ...
          <Card className="p-6 rounded-3xl border border-zinc-100 shadow-sm bg-white">
            ...
            <div className="text-xs font-black text-zinc-500 uppercase tracking-widest">Statut</div>
          </Card>
        </motion.div>
        ...
        >
          {isLevelComplete ? (
            <>
              <div className="p-6 rounded-3xl bg-indigo-50 border border-indigo-100 flex items-center gap-4 text-left">
              ...
              <Button
                ...
                size="lg"
                className="w-full h-14 text-sm font-black uppercase tracking-widest rounded-2xl bg-indigo-600 hover:bg-indigo-700 shadow-lg shadow-indigo-200 transition-all active:scale-[0.98] flex items-center justify-center gap-3"
              >
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Button
              ...
              variant="outline"
              size="lg"
              className="flex-1 h-14 rounded-2xl border border-zinc-200 font-black uppercase text-xs tracking-widest hover:bg-zinc-100 transition-all"
            >
            ...
            <Button
              ...
              variant="ghost"
              size="lg"
              className="flex-1 h-14 rounded-2xl font-black uppercase text-xs tracking-widest text-zinc-500 hover:text-red-600 transition-all"
            >
              Mode libre
            </Button>
          </div>
        ...
        <div className="pt-8 text-sm text-zinc-500 font-medium">
