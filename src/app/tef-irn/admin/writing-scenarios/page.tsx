    ...
    <div className="max-w-6xl mx-auto p-8 pt-12">
      <header className="flex justify-between items-end mb-8 flex-wrap gap-4">
        <div>
          ...
          <h1 className="text-3xl font-black tracking-tight text-zinc-900">Scénarios examen écrit (EE)</h1>
            ...
            <div key={s.id} className="flex items-start justify-between gap-4 p-5">
              <div className="space-y-1 min-w-0">
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  <Badge className="text-xs font-black uppercase bg-zinc-100 text-zinc-500 border-none">
                ...
                <p className="text-sm text-zinc-500">{s.min_words} mots min · {Math.round(s.duration_seconds / 60)} min</p>
              </div>
        ...
        <DialogContent className="max-w-2xl max-h-[85vh] overflow-y-auto">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-3 gap-3">
              ...
              <div>
                <Label className="text-xs font-black uppercase text-zinc-500">Type de texte</Label>
                <select value={form.type_texte} onChange={(e) => setForm((f) => ({ ...f, type_texte: e.target.value }))} className="mt-1 w-full h-10 px-3 rounded-2xl border border-zinc-200 text-sm font-bold">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                <Label className="text-xs font-black uppercase text-zinc-500">Durée (secondes)</Label>
                <Input
                  type="number"
