    ...
    <div className="min-h-screen bg-white selection:bg-blue-100 pb-20">
      ...
      <nav className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-zinc-50 px-6 py-4">
        <div className="max-w-6xl mx-auto flex justify-between items-center">
          <Link href="/tef-irn/guides" className="flex items-center gap-2 text-zinc-500 hover:text-blue-600 font-bold transition-colors">
            <ArrowLeft size={18} />
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href={currentUser ? "/tef-irn/dashboard" : "/tef-irn/login"}>
              <Button size="sm" className="bg-blue-600 font-black rounded-2xl shadow-lg shadow-blue-100 px-6">
                S'entraîner
              </Button>
            </Link>
          </div>
      ...
      <header className="max-w-6xl mx-auto px-6 pt-16 pb-12">
        ...
        >
          <div className="flex flex-wrap items-center gap-4">
            <Badge className="bg-blue-50 text-blue-600 hover:bg-blue-50 border-none font-black uppercase tracking-widest text-xs px-3 py-1">
              {guide.type}
            </Badge>
            {guide.level && (
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-6 py-6 border-y border-zinc-50">
             <div className="flex items-center gap-3">
                ...
                <div>
                   ...
                   <p className="text-sm text-zinc-500 font-medium">Expert TEF IRN & IA</p>
                </div>
             </div>
      ...
      <main className="max-w-6xl mx-auto px-6 pt-8">
        ...
        <section className="mt-24 p-8 lg:p-16 bg-blue-600 rounded-3xl text-white relative overflow-hidden shadow-xl shadow-blue-100">
          ...
          <div className="bg-zinc-50 rounded-3xl p-8 flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="flex-grow space-y-2 text-center md:text-left">
              ...
              <div className="flex flex-wrap justify-center md:justify-start gap-4 pt-2">
                <Badge variant="outline" className="bg-white border-zinc-200 text-zinc-500 font-bold">Expertise TEF IRN</Badge>
                <Badge variant="outline" className="bg-white border-zinc-200 text-zinc-500 font-bold">Certifié Qualiopi (en cours)</Badge>
        ...
        <div className="mt-12 flex flex-col sm:flex-row justify-between items-center gap-8">
           <Link href="/tef-irn/guides" className="text-blue-600 font-black flex items-center gap-2 hover:translate-x-1 transition-transform">
