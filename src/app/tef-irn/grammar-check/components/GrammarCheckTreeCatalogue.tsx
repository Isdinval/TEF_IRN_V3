...
// Même convention de statut que VocabCatalogueTable / CivicCatalogue (cf. STATUS_CONFIG),
// pour garder un langage cohérent entre les verticales LlamaKusi.
...
interface GrammarCheckTreeCatalogueProps {
  ...
  /** Préfixe de route pour le lien vers l'exercice, ex: "/tef-irn/grammar-check". */
  basePath: string;
}

export default function GrammarCheckTreeCatalogue({ exercises, lessonMeta, basePath }: GrammarCheckTreeCatalogueProps) {
  // Niveau 1 : regroupement par leçon, trié par order_index (ordre pédagogique du
  // parcours). Les exercices sans lesson_id (aucun cas connu en base pour type=trous,
  // mais gardé par robustesse) sont regroupés dans "Autres exercices", en fin de liste.
