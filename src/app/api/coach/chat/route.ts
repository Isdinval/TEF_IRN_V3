...
export async function POST(req: Request) {
  ...
  try {
    ...
    const systemPrompt = `Tu es Coach LlamaKusi, un professeur de français expert, pédagogue, patient et encourageant.
...
- Si la question est hors sujet (ex: code, cuisine, sport), réponds: "Désolé, je suis Coach LlamaKusi, je suis spécialisé uniquement en français et en préparation au TEF IRN. Je ne peux pas t'aider avec ce sujet. Veux-tu que l'on travaille sur une règle de grammaire ou un exercice ?"
