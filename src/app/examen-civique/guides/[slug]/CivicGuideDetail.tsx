    ...
    <div className="min-h-screen bg-white selection:bg-indigo-100 pb-20">
      ...
      <nav className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-gray-50 px-6 py-4">
        <div className="max-w-6xl mx-auto flex justify-between items-center">
          <Link href="/examen-civique/guides" className="flex items-center gap-2 text-slate-500 hover:text-indigo-600 font-bold transition-colors">
            <ArrowLeft size={18} />
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href="/examen-civique">
              <Button size="sm" className="bg-indigo-600 font-black rounded-xl shadow-lg shadow-indigo-100 px-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-6 py-6 border-y border-gray-50">
             <div className="flex items-center gap-3">
                ...
                <div>
                   ...
                   <p className="text-xs text-slate-400 font-medium">Ressources examen civique</p>
                </div>
             </div>
      ...
      <main className="max-w-6xl mx-auto px-6 pt-8">
        ...
        <section className="mt-24 p-8 lg:p-16 bg-indigo-600 rounded-[3rem] text-white relative overflow-hidden shadow-2xl shadow-indigo-100">
