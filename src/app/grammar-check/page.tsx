      ...
      <div className="max-w-6xl mx-auto p-6 lg:p-12 pt-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          <div className="lg:col-span-2 space-y-12">
            <header>
              ...
              <h1 className="text-5xl lg:text-6xl font-black text-slate-900 tracking-tighter mb-6">
                ZÉRO <span className="text-indigo-600">FAUTE.</span>
              </h1>
                ...
                <div className="grid grid-cols-2 gap-2">
                  {["A1", "A2", "B1", "B2"].map((l) => (
                    <button
                      ...
                      className={`h-14 rounded-2xl font-black text-lg transition-all ${selectedLevel === l ? 'bg-indigo-600 text-white shadow-xl shadow-indigo-100' : 'bg-white text-zinc-400 hover:bg-zinc-50 border border-zinc-100'}`}
                    >
                      {l}
                    </button>
                  ))}
                ...
                <div className="grid grid-cols-2 gap-2">
                  {["Grammaire", "Conjugaison", "Syntaxe", "Orthographe"].map((c) => (
                    <button
                      ...
                      className={`h-14 rounded-2xl font-black text-xs uppercase tracking-widest transition-all ${selectedCategory === c ? 'bg-indigo-600 text-white shadow-xl shadow-indigo-100' : 'bg-white text-zinc-400 hover:bg-zinc-50 border border-zinc-100'}`}
                    >
                      {c}
                    </button>
                  ))}
          ...
          <div className="space-y-8">
            <Card className="border-none shadow-2xl shadow-indigo-100 rounded-[3rem] p-8 bg-indigo-600 text-white relative overflow-hidden group">
        ...
        >
          <Card className="text-center p-12 rounded-[4rem] shadow-2xl shadow-indigo-100 border-none bg-white">
            ...
            <p className="text-zinc-400 mb-10 font-bold text-lg">
              Score final : <span className="text-indigo-600">{score}</span> / {questions.length}
            </p>
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 lg:p-12 pt-16">
      <header className="mb-12 flex justify-between items-center">
        <div>
           <Badge className="bg-indigo-600 text-[10px] font-black uppercase tracking-widest px-3 py-1 border-none mb-2">
        ...
        <div className="text-right">
          ...
          <div className="text-xl font-black text-indigo-600">{currentIdx + 1} / {questions.length}</div>
        </div>
      </header>
          ...
          <div className="relative">
             <input
              ...
              className={`w-full h-24 text-center text-3xl font-black rounded-3xl border-4 transition-all outline-none ${
                status === "typing" ? "border-zinc-100 focus:border-indigo-600 bg-white" :
             ...
             {status === "typing" ? (
              ...
              >
               ...
               <Button
                ...
                className={`w-full h-20 text-white font-black text-xl rounded-3xl ${status === "correct" ? "bg-emerald-600" : "bg-rose-500"}`}
              >
