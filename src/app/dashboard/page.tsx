          ...
          <CardContent className="space-y-4">
            {recommendations.length > 0 ? (
              <div className="p-4 border rounded-lg bg-indigo-50/50 border-indigo-100">
                ...
                <Button className="mt-4 bg-indigo-600 hover:bg-indigo-700">Continuer</Button>
              </div>
            ) : (
      ...
      <section>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {[
            ...
            { title: "Examen Blanc", icon: CheckCircle2, desc: "1h30 - Complet", href: "#" },
          ].map((item, i) => (
            <Card key={i} className="hover:border-indigo-300 transition-colors cursor-pointer group" onClick={() => item.href !== "#" && router.push(item.href)}>
