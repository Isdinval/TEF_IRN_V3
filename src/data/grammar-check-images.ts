...
// Poses "neutres" (état par défaut du Coach LlamaKusi) — 5 poses seulement, c'est voulu.
...
// Poses "reflechit" (état de chargement du Coach LlamaKusi, pendant que la réponse arrive).
