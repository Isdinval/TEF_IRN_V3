  ...
  const menuGroups = [
    {
      ...
      items: [
        ...
        { label: "Compréhension Écrite", icon: FileText, href: "/tef-irn/exam/comprehension-ecrite", section: "libre" as const },
        { label: "Compréhension Orale", icon: Headset, href: "/tef-irn/exam/comprehension-orale", section: "libre" as const },
