...
const features = [
  {
    ...
    color: "bg-blue-500",
    delay: 0.1,
    screenshot: "/screenshots/writing.png"
  },
  {
    ...
    color: "bg-purple-500",
    delay: 0.2,
    screenshot: "/screenshots/oral.png"
  },
  {
             ...
             >
                <Card className="group relative h-full rounded-[2.5rem] border-none bg-white/5 p-10 overflow-hidden hover:translate-y-[-10px] transition-all duration-500">
                   ...
                   <div className="relative mt-auto pt-10">
                      <div className="relative aspect-[4/3] rounded-2xl overflow-hidden border border-white/10 shadow-2xl transform translate-y-4 group-hover:translate-y-0 transition-transform duration-500 bg-slate-800">
                         <Image
                           src={f.screenshot}
                           alt={`Capture d'écran — ${f.title}`}
                           fill
                           className="object-cover object-top"
                         />
                      </div>

                      <div className="absolute top-0 right-0 -mr-6 -mt-6 w-24 h-24 bg-gradient-to-br from-white/0 to-white/10 rounded-full blur-2xl group-hover:blur-3xl transition-all" />
                   </div>
                </Card>
             </motion.div>
           ))}
