  ...
  return (
    <section id="pricing" className="py-32 px-6 bg-white dark:bg-brand-dark relative overflow-hidden">
      <div className="max-w-7xl mx-auto relative z-10">
             ...
             >
                ...
                <div className="mb-8">
                   ...
                   <div className="flex items-baseline gap-1">
                      {plan.price !== "0" && <span className="text-2xl font-bold">€</span>}
                      <span className="text-5xl font-black tracking-tighter">{plan.price}</span>
                      {plan.price !== "0" && <span className="text-sm font-bold opacity-70">/ mois</span>}
                   </div>
                </div>
        ...
        >
           <p className="flex items-center justify-center gap-2 text-slate-400 dark:text-slate-500 font-bold">
           ...
           <p className="flex items-center justify-center gap-2 text-sm font-black text-brand-purple">
             <Flame size={14} />
